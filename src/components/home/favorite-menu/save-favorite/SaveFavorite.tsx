    ...
    return (
        <div className={styles.wrapper}>
            ...
            <form onSubmit={create}>
                ...
                <button className={styles.submit_btn} disabled={name === '' || !calculation_data || !user_data || favorite_data == null || !!favorite_data.find(item => item.name === name.trim()) || req_proccess} type="submit">
